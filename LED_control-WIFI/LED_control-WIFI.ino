...
#define _SSID "orolfat99"
#define _KEY  "0960033155"

// Assign device id / key of your test device
MCSDevice mcs("DwoDCaLj", "t3OdfOXP0Met6AiG");
...
MCSControllerOnOff led("fat1");
MCSDisplayOnOff    remote("fat2");
MCSDisplayInteger  Temp("fact4");
